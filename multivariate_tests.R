...
#EBach, is fig_16S just the "source" code for the ggplot.NMDS figure?

#Date ("abundance")
ggplot.NMDS(mds, (subset(data.nosing.reads, reads>100)$Date), rainbow(2))
